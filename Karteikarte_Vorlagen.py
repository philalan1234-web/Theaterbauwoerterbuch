...
from pathlib import Path #verbessert Umgang mit Dateipfaden
...
if __name__ == "__main__":
    ...
    IMAGE_SOURCE_FOLDER = r"HIER IHREN PFAD ZUM EINZULESEDEN ORDNER EINGEBEN"
    OUTPUT_JSON_FILE = r"HIER IHREN PFAD ZUM ABSPEICHERN DER ERGEBNISSE EINGEBEN"
...
#---API-Setup---
    ...
    model = genai.GenerativeModel(model_name="HIER DEN VOLLSTÄNDIGEN MODELL-NAMEN DER KI EINGEBEN")
